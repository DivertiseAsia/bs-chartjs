...
let make = () => {
  ...
  <>
    demoCode
    <blockquote> <pre> <code> {React.string(demoCodeString)} </code> </pre> </blockquote>
    demoCode2
    <blockquote> <pre> <code> {React.string(demoCodeString2)} </code> </pre> </blockquote>
    demoCode3
    <blockquote> <pre> <code> {React.string(demoCodeString3)} </code> </pre> </blockquote>
  </>
}
